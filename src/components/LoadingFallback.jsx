...
export const LoadingFallback = ({ message = 'Loading...' }) => (
  <div className="flex flex-col items-center justify-center min-h-screen dark:bg-gray-900  bg-gray-50">
...
export const SidebarLoadingFallback = () => (
  <div className="w-96 h-full bg-white border-l dark:bg-gray-400/40  border-gray-200 flex items-center justify-center">
